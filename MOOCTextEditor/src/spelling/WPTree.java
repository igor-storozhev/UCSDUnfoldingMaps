...
public class WPTree implements WordPath {
	...
	public List<String> findPath(String word1, String word2) {
		...
		if (word1 == null || word2 == null) { // || dictionary.isWord(word2) ==
												// false) {
		...
		while (!queue.isEmpty()) {
			...
			for (String neighbor : neighbors) {
				...
				if (visited.contains(neighbor.toLowerCase()) == false) {
					...
					WPTreeNode child = curr.addChild(neighbor.toLowerCase());
	...
	/*
	 * public static void main(String[] args) { int incorrect = 0; int tests =
	 * 0; String feedback = "";
	 * 
	 * Dictionary dict = new DictionaryHashSet();
	 * DictionaryLoader.loadDictionary(dict, "data/grader_dict.txt"); WPTree
	 * tree = new WPTree(new NearbyWords(dict));
	 * 
	 * List<String> path = tree.findPath("pool", "spoon");
	 * 
	 * feedback += "** Test #1: Testing short path..."; feedback +=
	 * "Your path was: " + path + ".\n";
	 * 
	 * path = tree.findPath("stools", "moon");
	 * 
	 * feedback += "** Test #2: Testing long path..."; feedback +=
	 * "Your path was: " + path + ".\n";
	 * 
	 * path = tree.findPath("foal", "needless");
	 * 
	 * feedback += "** Test #3: Testing impossible path..."; feedback +=
	 * "Your path was: " + path + ".\n";
	 * 
	 * path = tree.findPath("needle", "kitten");
	 * 
	 * feedback += "** Test #4: Testing using a nonexistent word..."; feedback
	 * += "Your path was: " + path + ".\n";
	 * 
